    ...
    <section className="py-16 md:py-24 bg-[#f5f5f5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-16">
          ...
          <a
            href="#"
            className="text-[#f52e81] font-bold hover:text-[#e91e75] transition text-lg"
          >
            Find more Events →
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {events.map(event => (
            <div key={event.id} className="relative">
              ...
              {/* Event Card */}
              <div
                className={`${event.bgColor} rounded-2xl p-8 h-full flex flex-col pt-12 shadow-md hover:shadow-lg transition`}
              >
                {/* Image Area */}
                ...
                <div className="mt-6 pt-4 border-t border-gray-300/50">
                  <a
                    href="#"
                    className="text-[#f52e81] font-bold hover:text-[#e91e75] transition inline-flex items-center gap-2"
                  >
                    Learn More →
                  </a>
                </div>
