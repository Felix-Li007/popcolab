...
export default function NewRequestModal({
  ...
  function handleSubmitClick(e: React.MouseEvent<HTMLButtonElement>) {
    if (individualInvites.length === 0 && teamInvites.length === 0) {
      e.preventDefault();
      setInviteError(
        'Please invite at least one person or team before submitting.'
      );
    }
  }
    ...
    >
      <div className="w-full max-w-[600px] max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-2xl">
        ...
        <form action={formAction}>
            ...
            <div className="p-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-400 mb-3">
                  Search by name or email, or type any email address to invite
                  someone directly.
                </p>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={e => {
                      setIndividualQuery(e.target.value);
          ...
          {/* Footer */}
          <div className="sticky bottom-0 flex justify-between gap-3 border-t border-gray-100 bg-white px-6 py-4 rounded-b-2xl">
            {step === 1 ? (
              <>
                <button
                  type="button"
