...
const experiences = [
  {
    id: 1,
    image:
      'https://tse1.mm.bing.net/th/id/OIP.JBlFLG5dUdwSdqw9yeo_8gHaLH?pid=ImgDet&w=178&h=267&c=7&dpr=1.5&o=7&rm=3',
  ...
  },
  {
    id: 2,
    image:
      'https://tse4.mm.bing.net/th/id/OIP.cMDMeLnayv4BkvlV7gGbagHaD4?rs=1&pid=ImgDetMain&o=7&rm=3',
  ...
  },
  {
    id: 3,
    image:
      'https://th.bing.com/th/id/OIP.ufV2lSjMJvLAyTUhK7t5hwHaEO?w=305&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-12">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <p className="text-sm text-[#6390a4] font-semibold">
              {current.subtitle}
            </p>
